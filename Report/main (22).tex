...
% Optional: Abstract (we can add later if you want)
% \chapter*{ABSTRACT}
...
\chapter{PROBLEM DEFINITION AND FORMAL METRICS}
...
\chapter{DESIGN PRINCIPLES AND SYSTEM INVARIANTS}
...
\chapter{DETERMINISTIC DRIFT MECHANISM}
...
\begin{itemize}
    ...
    \item Commit hash: \textbf{[FILL: git rev-parse HEAD]}
    \item Extension build method: \textbf{[FILL: packed/unpacked]}
\end{itemize}
...
\begin{itemize}
    ...
    \item Epoch count: 3
    \item Epoch definition: \textbf{[FILL: time-based / run-based]}
    \item Surfaces enabled: \textbf{[FILL: Canvas, WebGL, Audio, Navigator, Screen, Intl]}
...
\begin{itemize}
    ...
    \item Crawl automation tool: \textbf{[FILL]}
    \item Timeouts and retries: \textbf{[FILL]}
\end{itemize}
...
\begin{itemize}
    ...
    \item Aggregated metrics: \textbf{[FILL: file name(s)]}
    \item Figures: \textbf{[FILL: list figure filenames]}
\end{itemize}
